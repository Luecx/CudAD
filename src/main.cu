...
std::string output = "../resources/runs/experiment_21/";
...
//    network.loadWeights(output + "weights-epoch" + std::to_string(409) + ".nn");
//    computeScalars(batch_loader, network, 1024, I);
//    quantitize(output + "weights-epoch" + std::to_string(409) + ".net", network, 16, 256);
